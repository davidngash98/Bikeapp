from .views import register, loginPage, index, logout_user, CreateProfilePage, profile, EditProfileView , bike_station, bike ,bikesPerStation, rate_project, checkout
